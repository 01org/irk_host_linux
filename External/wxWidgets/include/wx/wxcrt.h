...
#include <string.h>
    ...
    inline wxChar* wxTmemcpy(wxChar* szOut, size_t size, const wxChar* szIn, size_t len)
    {
#if wxGCS_SECURITY && defined(WIN32)
        return (wxChar*)memcpy_s(szOut, size, szIn, len * sizeof(wxChar));
#else
        wxUnusedVar(size);
...
inline char* wxTmemcpy(char* szOut, size_t size, const char* szIn, size_t len)
{
#if wxGCS_SECURITY && defined(WIN32)
    return (char*)memcpy_s(szOut, size, szIn, len);
#else
    wxUnusedVar(size);
...
inline char *wxStrcpy(char *dest, size_t numberOfElements, const char *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcpy_s(dest, numberOfElements, src);
    return dest;
#else
    wxUnusedVar(numberOfElements);
    return wxCRT_StrcpyA(dest, src);
#endif
}

inline wchar_t *wxStrcpy(wchar_t *dest, size_t numberOfElements, const wchar_t *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscpy_s(dest, numberOfElements, src);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcpy(char *dest, size_t numberOfElements, const wxString& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcpy_s(dest, numberOfElements, src.mb_str());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcpy(char *dest, size_t numberOfElements, const wxCStrData& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcpy_s(dest, numberOfElements, src.AsCharBuf());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcpy(char *dest, size_t numberOfElements, const wxScopedCharBuffer& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcpy_s(dest, numberOfElements, src.data());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcpy(wchar_t *dest, size_t numberOfElements, const wxString& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscpy_s(dest, numberOfElements, src.wc_str());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcpy(wchar_t *dest, size_t numberOfElements, const wxCStrData& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscpy_s(dest, numberOfElements, src.AsWCharBuf());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcpy(wchar_t *dest, size_t numberOfElements, const wxScopedWCharBuffer& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscpy_s(dest, numberOfElements, src.data());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcpy(char *dest, size_t numberOfElements, const wchar_t *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcpy_s(dest, numberOfElements, wxConvLibc.cWC2MB(src));
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcpy(wchar_t *dest, size_t numberOfElements, const char *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscpy_s(dest, numberOfElements, wxConvLibc.cMB2WC(src));
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncpy(char *dest, size_t numberOfElements, const char *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncpy_s(dest, numberOfElements, src, n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncpy(wchar_t *dest, size_t numberOfElements, const wchar_t *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncpy_s(dest, numberOfElements, src, n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncpy(char *dest, size_t numberOfElements, const wxString& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncpy_s(dest, numberOfElements, src.mb_str(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncpy(char *dest, size_t numberOfElements, const wxCStrData& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncpy_s(dest, numberOfElements, src.AsCharBuf(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncpy(char *dest, size_t numberOfElements, const wxScopedCharBuffer& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncpy_s(dest, numberOfElements, src.data(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncpy(wchar_t *dest, size_t numberOfElements, const wxString& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncpy_s(dest, numberOfElements, src.wc_str(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncpy(wchar_t *dest, size_t numberOfElements, const wxCStrData& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncpy_s(dest, numberOfElements, src.AsWCharBuf(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncpy(wchar_t *dest, size_t numberOfElements, const wxScopedWCharBuffer& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncpy_s(dest, numberOfElements, src.data(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncpy(char *dest, size_t numberOfElements, const wchar_t *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncpy_s(dest, numberOfElements, wxConvLibc.cWC2MB(src), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncpy(wchar_t *dest, size_t numberOfElements, const char *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncpy_s(dest, numberOfElements, wxConvLibc.cMB2WC(src), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline size_t wxStrlcpy(char *dest, size_t numberOfElements, const char *src, size_t n)
{
    ...
    if ( n )
    {
        if ( n-- > len )
            n = len;
        wxStrncpy(dest, numberOfElements, src, n);
        dest[n] = '\0';
    }

    return len;
}
inline size_t wxStrlcpy(wchar_t *dest, size_t numberOfElements, const wchar_t *src, size_t n)
{
...
inline char *wxStrcat(char *dest, size_t numberOfElements, const char *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcat_s(dest, numberOfElements, src);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcat(wchar_t *dest, size_t numberOfElements, const wchar_t *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscat_s(dest, numberOfElements, src);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcat(char *dest, size_t numberOfElements, const wxString& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcat_s(dest, numberOfElements, src.mb_str());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcat(char *dest, size_t numberOfElements, const wxCStrData& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcat_s(dest, numberOfElements, src.AsCharBuf());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcat(char *dest, size_t numberOfElements, const wxScopedCharBuffer& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcat_s(dest, numberOfElements, src.data());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcat(wchar_t *dest, size_t numberOfElements, const wxString& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscat_s(dest, numberOfElements, src.wc_str());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcat(wchar_t *dest, size_t numberOfElements, const wxCStrData& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscat_s(dest, numberOfElements, src.AsWCharBuf());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcat(wchar_t *dest, size_t numberOfElements, const wxScopedWCharBuffer& src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscat_s(dest, numberOfElements, src.data());
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrcat(char *dest, size_t numberOfElements, const wchar_t *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    strcat_s(dest, numberOfElements, wxConvLibc.cWC2MB(src));
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrcat(wchar_t *dest, size_t numberOfElements, const char *src)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcscat_s(dest, numberOfElements, wxConvLibc.cMB2WC(src));
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncat(char *dest, size_t numberOfElements, const char *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncat_s(dest, numberOfElements, src, n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncat(wchar_t *dest, size_t numberOfElements, const wchar_t *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncat_s(dest, numberOfElements, src, n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncat(char *dest, size_t numberOfElements, const wxString& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncat_s(dest, numberOfElements, src.mb_str(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncat(char *dest, size_t numberOfElements, const wxCStrData& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncat_s(dest, numberOfElements, src.AsCharBuf(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncat(char *dest, size_t numberOfElements, const wxScopedCharBuffer& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncat_s(dest, numberOfElements, src.data(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncat(wchar_t *dest, size_t numberOfElements, const wxString& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncat_s(dest, numberOfElements, src.wc_str(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncat(wchar_t *dest, size_t numberOfElements, const wxCStrData& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncat_s(dest, numberOfElements, src.AsWCharBuf(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncat(wchar_t *dest, size_t numberOfElements, const wxScopedWCharBuffer& src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncat_s(dest, numberOfElements, src.data(), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline char *wxStrncat(char *dest, size_t numberOfElements, const wchar_t *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    strncat_s(dest, numberOfElements, wxConvLibc.cWC2MB(src), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
...
inline wchar_t *wxStrncat(wchar_t *dest, size_t numberOfElements, const char *src, size_t n)
{
#if wxGCS_SECURITY && defined(WIN32)
    wcsncat_s(dest, numberOfElements, wxConvLibc.cMB2WC(src), n);
    return dest;
#else
    wxUnusedVar(numberOfElements);
