                              ...
                              bool async)
{
    ...
    wxStrlcpy(rasDialParams.szEntryName, WXSIZEOF(rasDialParams.szEntryName), entryName.c_str(), RAS_MaxEntryName);
    ...
    {
        wxStrlcpy(rasDialParams.szUserName, WXSIZEOF(rasDialParams.szUserName), username.c_str(), UNLEN);
        wxStrlcpy(rasDialParams.szPassword, WXSIZEOF(rasDialParams.szPassword), password.c_str(), PWLEN);
    }
