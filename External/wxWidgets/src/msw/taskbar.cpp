...
bool wxTaskBarIcon::SetIcon(const wxIcon& icon, const wxString& tooltip)
{
    ...
    if ( !tooltip.empty() )
    {
        wxStrlcpy(notifyData.szTip, WXSIZEOF(notifyData.szTip), tooltip.t_str(), WXSIZEOF(notifyData.szTip));
    }
                           ...
                           int flags)
{
    ...
    wxStrlcpy(notifyData.szInfo, WXSIZEOF(notifyData.szInfo), text.t_str(), WXSIZEOF(notifyData.szInfo));
    wxStrlcpy(notifyData.szInfoTitle, WXSIZEOF(notifyData.szInfoTitle), title.t_str(), WXSIZEOF(notifyData.szInfoTitle));
...
bool wxTaskBarIcon::PopupMenu(wxMenu *menu)
{
    ...
    {
        m_win->Move(x - m_win->GetSize().x, y);
    }
