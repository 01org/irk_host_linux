...
// Assignment
wxVariant& wxVariant::operator= (const wxVariant& variant) // wxGCS_SECURITY
{
    Ref(variant);
    m_name = variant.m_name;
    return *this;
...
wxVariant& wxVariant::operator= (wxVariantData* variantData) // wxGCS_SECURITY
{
    UnRef();
...
wxVariant& wxVariant::operator= (long value) // wxGCS_SECURITY
{
    if (GetType() == wxT("long") &&
...
wxVariant& wxVariant::operator= (double value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator= (bool value) // wxGCS_SECURITY
{
    if (GetType() == wxT("bool") &&
        m_refData->GetRefCount() == 1)
    {
...
wxVariant& wxVariant::operator= (wxObject* value) // wxGCS_SECURITY
{
    UnRef();
...
wxVariant& wxVariant::operator= (void* value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator= (const wxDateTime& value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator=(const wxArrayString& value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator=(wxLongLong value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator=(wxULongLong value) // wxGCS_SECURITY
{
...
wxVariant& wxVariant::operator= (const wxVariantList& value) // wxGCS_SECURITY
{
    if (GetType() == wxT("list") &&
        m_refData->GetRefCount() == 1)
    {
